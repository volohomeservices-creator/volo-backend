...
async function GET(request) {
  try {
    ...
    const { data: invoices, error } = await supabaseAdmin.from("invoices").select("*, bookings(address_line, service_items(name), created_at)").eq("customer_id", customerId).order("created_at", { ascending: false });
    if (error) {
