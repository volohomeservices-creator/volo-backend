...
// src/app/api/admin/queued-bookings/route.ts
var route_exports = {};
...
// packages/shared-lib/src/lib/pagination.ts
function getPaginationParams(searchParams, defaultLimit = 20, maxLimit = 100) {
  let page = 1;
...
async function GET(request) {
  try {
    ...
    const { data: bookings, count, error } = await supabaseAdmin.from("bookings").select(`
        id,
        status,
        address_line,
        created_at,
      ...
      `, { count: "exact" }).eq("status", "MANUAL_ASSIGNMENT_REQUIRED").order("created_at", { ascending: false }).range(offset, offset + limit - 1);
    if (error) {
    ...
    const mappedBookings = (bookings || []).map((b) => {
      ...
      const waitingMins = Math.round((now - createdAtTime) / 6e4);
      return {
        id: b.id,
        created_at: b.created_at,
        address_line: b.address_line,
        customer_name: ((_a2 = b.customer) == null ? void 0 : _a2.full_name) || "N/A",
        customer_phone: ((_b = b.customer) == null ? void 0 : _b.phone) || "N/A",
        service_name: ((_c = b.service_items) == null ? void 0 : _c.name) || "N/A",
        category_name: ((_e = (_d = b.service_items) == null ? void 0 : _d.service_categories) == null ? void 0 : _e.name) || "N/A",
        attempts: ((_f = b.assignment_queue) == null ? void 0 : _f.attempts) || 0,
        current_group: ((_g = b.assignment_queue) == null ? void 0 : _g.current_group) || 0,
        started_at: ((_h = b.assignment_queue) == null ? void 0 : _h.started_at) || null,
