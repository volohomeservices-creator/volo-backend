...
async function GET(request) {
  try {
    ...
    let query = supabaseAdmin2.from("reviews").select(`
        id,
        rating,
        comment:review_text,
        is_hidden,
    ...
    const formattedData = data.map((row) => {
      ...
      return {
        ...
        service_name: (_b = (_a2 = row.bookings) == null ? void 0 : _a2.service_items) == null ? void 0 : _b.name,
        customer_name: (_c = row.customer) == null ? void 0 : _c.full_name,
        worker_name: (_e = (_d = row.worker) == null ? void 0 : _d.users) == null ? void 0 : _e.full_name
      };
    });
