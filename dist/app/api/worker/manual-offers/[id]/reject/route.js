...
// src/app/api/worker/manual-offers/[id]/reject/route.ts
var route_exports = {};
...
// packages/shared-lib/src/lib/manual-assignment.ts
var SYSTEM_ADMIN_ID = "ad8e7a68-b7eb-4b2a-8cfa-c529a65f9733";
async function rejectManualAssignmentOffer(offerId, workerId, reason) {
  ...
  await supabaseAdmin.from("manual_assignment_history").update({ status: "REJECTED", updated_at: (/* @__PURE__ */ new Date()).toISOString() }).eq("id", offerId);
  ...
  await logAuditAction({
    ...
    // Sys logger
    action: "MANUAL_ASSIGNMENT_REJECTED" /* MANUAL_ASSIGNMENT_REJECTED */,
    target_type: "booking",
    target_id: bookingId,
