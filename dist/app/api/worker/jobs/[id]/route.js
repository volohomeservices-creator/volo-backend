...
// src/app/api/worker/jobs/[id]/route.ts
var route_exports = {};
...
async function GET(request, { params }) {
  ...
  try {
    ...
    const { data: booking, error } = await supabaseAdmin.from("bookings").select("*, service_items(*), customer:users!bookings_customer_id_fkey(*)").eq("id", id).single();
    if (error || !booking) {
    ...
    return NextResponse.json({
      ...
      customer: {
        id: (_a2 = booking.customer) == null ? void 0 : _a2.id,
        full_name: (_b = booking.customer) == null ? void 0 : _b.full_name,
        phone: (_c = booking.customer) == null ? void 0 : _c.phone,
        email: (_d = booking.customer) == null ? void 0 : _d.email
      }
