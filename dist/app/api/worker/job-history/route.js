...
// src/app/api/worker/job-history/route.ts
var route_exports = {};
...
async function GET(request) {
  try {
    ...
    let query = supabaseAdmin.from("bookings").select("*, service_items!inner(name), customer:users!bookings_customer_id_fkey(full_name, phone)", { count: "exact" }).eq("worker_id", workerId);
    if (status) {
